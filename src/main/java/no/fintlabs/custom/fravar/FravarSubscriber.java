...
public class FravarSubscriber extends ResourceSubscriber<FravarResource, FravarPublisher> {
    ...
    protected FravarSubscriber(WebClient webClient, @Qualifier("fint") AdapterInstanceProperties props, FravarPublisher publisher) {
    ...
    protected AdapterCapability getCapability() {
        ...
        return adapterInstanceProperties.getCapabilities().get("fravar");
    }
